...
class tbug():
    ...
    def __init__(self):
        ...
        self.laser_subscriber = rospy.Subscriber('/scan', LaserScan, self.callback_laser, DEFAULT_OBSTACLE_JUMP)
    ...
    def callback_Pose(self,pose):
        ...
        if self.callbackDonePose == False:
            self.current_position = pose.pose.pose.position
            self.current_orientation = pose.pose.pose.orientation
